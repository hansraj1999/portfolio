...
async function loadProjects() {
    ...
    try {
        ...
        projectsGrid.innerHTML = projects.map(project => {
            ...
            return `
            <div class="project-card" data-project-id="${escapeHtml(project.name.toLowerCase().replace(/\s+/g, '-'))}">
                ...
                <div class="project-buttons">
                    ...
                    ` : ''}
                    ${hasDetails ? `
                        <button class="project-btn project-btn-details" data-project='${JSON.stringify(project).replace(/'/g, "&#39;")}'>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        // Add event delegation for details buttons after rendering (use once to prevent duplicates)
        ...
        projectsGrid.removeEventListener('click', handleDetailsClick);
        projectsGrid.addEventListener('click', handleDetailsClick);
    } catch (error) {
